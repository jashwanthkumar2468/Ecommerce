...
(function(factory) {
  ...
  $.extend(CcPicker.prototype, {
    ...
    createCountryListItem: function (countryCode, dialCode) {
      return '<div class="cc-picker-flag ' + countryCode.toLowerCase() + '"></div><span class="cc-picker-code" id="countrycode">' + dialCode + '</span><input type="hidden" id="ccode" name="ccode" value="' + dialCode + '">';
    }
  });
