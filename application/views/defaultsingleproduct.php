                            ...
                            <div class="sp-content">
                                ...
                                <div class="sp-essential_stuff">
                                    <ul>
										...
										<?php if($singleproduct['pricestatus']==1)
										{?>
										<li><h4 style="color:black;font-size:27px;">Rs: <?php echo $singleproduct['TotalPrice']; ?></h4></li>
													...
													<ul class="pricebrdown">
                                                        <li id="pb_metalprice">
															...
															<span>Gold</span><span>Rs. <?php echo $singleproduct['GoldPrice']; ?></span>
															</div>
														</li>
									        		    ...
									        		    <div class="breakup_content">
																<span>Wastage(%)</span>
										<?php 
										$aaa=	($singleproduct['DiamondPrice'] * $singleproduct['dcts']) + ($singleproduct['GoldPrice'] + $singleproduct['PlatinumPrice']);
										$b=($singleproduct['MakingCahrges']/100)* $aaa;
										
										?>					
																<span class="offer_new_price">Rs. <?php echo $b; ?></span>
															</div></li>
									        
									        
														<li id="pb_diamondcharge">
									    <?php if( $singleproduct['ProductTypeForFixedNonFixed']==1) { ?>
									        		
									   <?php  }
									    if($singleproduct['ProductTypeForFixedNonFixed']==2)
									    { ?>
															<div class="breakup_content">
																<span>Diamond</span>
													...
													<li>	<div class="breakup_content">
																<span>Stone Price</span>
											<span class="offer_new_price">Rs. <?php echo  $singleproduct['stoneprice']; ?></span>
												</div></li>
                                                 <li id="pb_makingcharge">
															<div class="breakup_content">
																<span>MakingCharges</span><span class="orig_making_charge">Rs. <?php echo $singleproduct['makchargeamount']; ?></span>
															</div>
														</li>
                                                        <li id="pb_vat">
								...
								<div class="row" style="margin-top:-10px;margin-bottom:20px;">
									...
									<div class="qty-btn_area" style="padding-top:23px;">
										<ul>
											<li><a class="qty-cart_btn" href="javascript:void(0)" onclick="ccart(<?php echo $singleproduct['ProductId'];?>,'<?php echo $this->session->userdata('uid1') ;?>')">Add To Cart</a></li>
										...
										<!--<div class="quantity" style="padding-top:25px;">
											...
											<div class="cart-plus-minus">
												<input class="cart-plus-minus-box" value="1" type="text" style="height:40px;">
		...
		<div class="row" style="padding-top:10px;">
			<div class="container-fluid" style="background-color:#f3f3f3;padding-bottom:40px;">
				<div class="col-md-12" style="padding:0px;">
					<h5 class="product-details-head" style="text-transform:uppercase;font-weight:700;text-align:center;padding: 20px 10px 18px 15px;">Product Details</h5>
				</div>
					...
					<div id="leftparentdiv" class="col-xs-12 col-md-12">
						<div class="row" style="background-color:#f3f3f3">
							<div class="accordion col-md-4">
								<div class="product-detail-info-head"  style="color:#595959;">Basic Information</div>
								<ul>
									<li><span class="f-left col-md-6">Product Type</span>
										<span class="f-right col-md-6 product_type"><?php echo $submenunames['SubCategoryName'];?></span>
									</li>
									<li><span class="f-left col-md-6">Brands</span>
										<span class="f-right col-md-6 brand">Premlal</span>
									</li>
									<li><span class="f-left col-md-6">Item package quantity</span>
										<span class="f-right col-md-6 item_package_quantity"><?php echo $singleproduct['Quantity'];?></span>
									</li>
									<li><span class="f-left col-md-6">Gender</span>
										<span class="f-right col-md-6 gender"><?php   
										if($singleproduct['gender1']==1)
										{
							...
							<div class="accordion col-md-4">
								<div class="product-detail-info-head" style="color:#595959;">Metal Information</div>
								<ul>
									<li><span class="f-left col-md-6">Gold Purity</span>
										<span class="f-right col-md-6 gold_purity"><?php echo $singleproduct['GoldCaret'];?></span>
									</li>
									<li><span class="f-left col-md-6">Metal Colour</span>
										<span class="f-right col-md-6 gold_colour">Yellow</span>
									</li>
									<li><span class="f-left col-md-6">Gross Weight ( g )</span>
										<span class="f-right col-md-6 gross_gold_weight"><?php echo $singleproduct['grw'];?></span>
									</li>
									<li><span class="f-left col-md-6">Net Weight ( g )</span>
										<span class="f-right col-md-6 net_gold_weight"><?php echo $singleproduct['gms'];?></span>
									</li>
								</ul>
                    		</div>
							<div class="accordion col-md-4">
								<div class="product-detail-info-head" style="color:#595959;">Stone Information</div>
								<ul>
									<li><span class="f-left col-md-6">Stone Weight ( g )</span>
										<span class="f-right col-md-6 stone_weight"><?php echo $singleproduct['stw'];?></span>
									</li>
								</ul>
                    		</div>
						</div>
