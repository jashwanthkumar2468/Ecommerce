		...
		success:function(data){
			...
			if(data.userdetails!='')
			{
				...
				$.each(data.userdetails, function(i){
					...
					$n = n++;
					html+=" <tr><td>"+$n+"</td><td>"+row.firstname+"</td><td>"+row.lastname+"</td><td>"+row.email+"</td><td><a href='<?php echo base_url('EcoDashAdmin/UserOrdersView/"+row.uid+"'); ?>'><button class='btn btn-warning btn-xs'style='background: #204079;border-color: #204079;'><i class='fa fa-eye'>&nbsp;View</i></button></a></td></tr>";
				}); 
			}
			else 
