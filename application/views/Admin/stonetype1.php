		...
		<div class="box box-default">
			...
			<div class="box-body" id="AddBdy" style="display:none">
				<form id="CategoryAddForm" onsubmit="return false;" method="post" enctype='multipart/form-data'>
						...
						<div class="col-md-3">
                         ...
                         <div class="col-md-3">
							<div class="form-group"> 
								...
								<input type="text" class="form-control required" name="stoneprice" id="stoneprice" placeholder="Enter Stone Price"/> 
							</div>
						</div>
					...
					<input type="hidden" name="Add_Edit_Stone_Type1" value="true"/>
					<div class="row">  
						<div class="col-md-3"> 
		...
		success:function(data){
			...
			if(data.get_stonetype!='')
			{
				...
				$.each(data.get_stonetype, function(i){
					...
					html+=" <tr><td>"+$n+"</td><td>"+row.stonename+"</td><td>"+row.stoneprice+"</td><td><button class='btn btn-primary btn-xs' onclick='edit("+row.StoneId+")'><i class='fa fa-pencil'></i></button>&nbsp;&nbsp;&nbsp;<button class='btn btn-danger btn-xs' onclick='del("+row.StoneId+")'><i class='fa fa-trash'></i></button></td></tr>";
				});
			}
			else
		...
		$.ajax({
			...
			success:function(data){
				...
				if(data.installation!='')
				{
					...
					$('#stoneprice').val(data.stoneprice);					
					$('#AddBdy').show();
				}
			}
		});
