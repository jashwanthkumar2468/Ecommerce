...
<body class="template-color-1">
    <div class="main-wrapper">
	   ...
	   <div class="col-md-4 paddclass">
			   ...
			   <a href="<?php echo base_url("EcoDashAdmin/StaffMembers")?>"> <button class="btn btn-info btnstyle" style="font-size: 20px;"><i class="fa fa-arrow-left"></i>&nbsp;&nbsp;Back</button></a>
			   </div>
	   </div>
	   <div class="col-md-4">
        ...
        <div class="col-md-4 paddclass">
			  ...
			  <a href="<?php echo base_url('EcoDashAdmin/ShoppingCart1/'.$auid.'');?>">
                                ...
                                <div class="card actives">
                                    <div class="card-header" id="headingOne"  style="background:white;">
                                        <h5 class="mb-0" style="color:black;font-size: 18px;">
											<a href="javascript:void(0)"  style="color: black;font-size: 18px;text-decoration: none;" class="collapsed" data-toggle="collapse" data-target="#collapseOne<?php echo $mcat['CategoryId'];?>" aria-expanded="false" aria-controls="collapseOne" onclick="getproductsparent(<?php echo $mcat['CategoryId'];?>)">
									...
									<div class="card-body">
										...
										//{
											...
											//{ ?>
												<li class="subcats" style="list-style:none;"><i class="fa fa-long-arrow-right" aria-hidden="true" style="font-size:15px;"></i>
                    ...
                    <div class="col-lg-12 order-1 order-lg-2">
                        <div class="shop-toolbar">
							...
							<!--<input type="checkbox" class="checkbox_selector" /> -->
										<div id="checkbox_selector" class="btn btn-primary checkbox_selector" style="font-size:12px;background:#85501b;color:white;height:30px;padding: 4px;border: 1px solid #888888;float: left;margin-top: 23px;margin-right: 10px;margin-left:45px;width:30%;font-weight:500;">Select All</div> 
										<div class="form-group">
											<label for="price-min" ></label>
												<div>
													<button onclick="loginclick()" id="myDiv" style="font-size:12px;background:#85501b;color:white;height:30px;display:none;padding: 4px;border: 1px solid #888888;margin-top: 9px;margin-right: 10px;width:30%;font-weight:500;">Submit</button>
												</div>
										</div>
									</div>
			...
			if(!empty($products))
			{
			 foreach($products as $pd)
			 {
				...
				<img class="primary-img" src="<?php echo $pd['Image'];?>" alt=" Product Image">	
					<input type="checkbox" name="check[]" value="<?php echo $pd['ProductId'];?>" id="checks" class="checkBoxClass">
     ...
     function getfiletr(){
		...
		if(selectparent=='' && selectsub == '')
		{
		 ...
		 getSubCatlist(finalparent,finalsubcat);
		  ...
		  if(finalparent=='' && finalsubcat=='' && selectsublist=='' && selectgender=='' && description=='' && weight=='' && minprice=='' && maxprice=='')
		  {
		...
		var uid= '<?php echo $auid;?>';
          $.ajax({	
		url:"<?php echo base_url(); ?>EcoDashAdmin/StaffFilterSide",
		method : "POST", 
		data:{'get':'getFilterProducts','uid':uid,'description':description,'weight':weight,'minprice':minprice,'maxprice':maxprice,'selectparent':finalparent,'selectsub':finalsubcat,'selectsublist':selectsublist,'selectgender':selectgender},
		success:function(data){
			//alert(catId); 
			data = $.parseJSON(data);       
